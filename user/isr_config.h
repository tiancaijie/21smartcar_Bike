...
#define CCU6_0_CH0_ISR_PRIORITY 70	                // 定义CCU6_0 PIT通道0中断优先级 优先级范围1-255 越大优先级越高 与平时使用的单片机不一样
...
#define DMA_INT_SERVICE_2       IfxSrc_Tos_cpu1
#define DMA_INT_PRIO_2          62
...
// 定义串口0发送中断优先级 优先级范围1-255 越大优先级越高 与平时使用的单片机不一样
