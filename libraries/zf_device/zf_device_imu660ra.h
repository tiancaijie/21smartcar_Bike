...
//#define IMU660RA_SCL_PIN              (P33_9)                                  // 软件 IIC SCL 引脚 连接 IMU660RA 的 SCL 引脚
//#define IMU660RA_SDA_PIN              (P33_12)                                  // 软件 IIC SDA 引脚 连接 IMU660RA 的 SDA 引脚
////====================================================软件 IIC 驱动====================================================
//#else
////====================================================硬件 SPI 驱动====================================================
...
////====================================================硬件 SPI 驱动====================================================
//#endif
//#define IMU660RA_CS_PIN               (P32_0)                                  // CS 片选引脚
...
////#define IMU660RA_GYRO_SAMPLE_DEFAULT  ( IMU660RA_GYRO_SAMPLE_SGN_500DPS )      // 在这设置默认的 陀螺仪   初始化量程IMU660RA_GYRO_SAMPLE_SGN_500DPS
...
//void  imu660ra_data_trans           (void);                                     // 转化 IMU660RA 数据
//void  imu660ra_offset               (void);                                     // 初始化后去零飘 IMU660RA 数据
////================================================声明 IMU660RA 基础函数================================================
//
//
////================================================声明 IMU660RA 拓展函数================================================
