...
#define IMU963RA_SCL_PIN                            (P22_2)                     // 软件 IIC SCL 引脚 连接 IMU963RA 的 SCL 引脚
#define IMU963RA_SDA_PIN                            (P21_4)                     // 软件 IIC SDA 引脚 连接 IMU963RA 的 SDA 引脚
//====================================================软件 IIC 驱动====================================================
#else
...
#define                                (SPI0_MISO_P20_12)          // 硬件 SPI MISO 引脚
//====================================================硬件 SPI 驱动====================================================
#endif

#define IMU963RA_CS_PIN                             (P21_6)                    // CS 片选引脚
...
void    imu963_data_trans           (void);                                     // 转化 IMU963数据
