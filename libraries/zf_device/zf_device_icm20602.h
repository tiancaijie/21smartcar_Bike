...
//#define ICM20602_SCL_PIN            (P33_9)                                    // 软件 IIC SCL 引脚 连接 ICM20602 的 SCL 引脚
//#define ICM20602_SDA_PIN            (P33_12)                                    // 软件 IIC SDA 引脚 连接 ICM20602 的 SDA 引脚
//
////====================================================软件 IIC 驱动====================================================
//#else
////====================================================硬件 SPI 驱动====================================================
...
//#define ICM20602_GYRO_SAMPLE_DEFAULT    ( ICM20602_GYRO_SAMPLE_SGN_1000DPS )    // 在这设置默认的 陀螺仪   初始化量程
//
//#define Temperature                 (1.005766218)                               //温度补偿系数
...
//void    icm20602_data_trans         (void);                                     // 转化 ICM20602 加速度计数据
//void    icm20602_offset             (void);                                     // 转化 ICM20602 加速度计数据
////================================================声明 ICM20602 基础函数================================================
//
//
////================================================声明 ICM20602 拓展函数================================================
